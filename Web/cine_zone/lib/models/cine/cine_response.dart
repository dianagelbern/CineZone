class CinesResponse {
  ...
  CinesResponse.fromJson(Map<String, dynamic> json) {
    content = List.from(json['content']).map((e) => Cine.fromJson(e)).toList();
...
class Cine {
  ...
  Cine.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    nombre = json['nombre'];
