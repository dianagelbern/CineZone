class ShowsByMovieResponse {
  ShowsByMovieResponse({
  ...
  late final List<MovieShow> content;
  ...
  ShowsByMovieResponse.fromJson(Map<String, dynamic> json) {
    content =
        List.from(json['content']).map((e) => MovieShow.fromJson(e)).toList();
...
class MovieShow {
  ...
  MovieShow.fromJson(Map<String, dynamic> json) {
    id = json['id'];
